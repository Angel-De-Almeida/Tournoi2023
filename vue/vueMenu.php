...
<header>
    <div class="menu">
            ...
            <div class="menu_logo">
                <h2><a href="http://172.16.255.24/~tournoi2023/Tournoi2023/" class="logo">WIIZ</a></h2>
            </div>

            <div class="menu_nav">
                <nav class="navigation" >
                    <a href="http://172.16.255.24/~tournoi2023/Tournoi2023/vue/vueTournoi.php" button class="links">Tournois</button> </a>
    
                    <?php 
                        if($role ==1 ){
                            echo '<a href="http://172.16.255.24/~tournoi2023/Tournoi2023/vue/vueAdministrateur.php" button class="links">Administrateur</button> </a>';
                        }?>
                </nav>
            </div>
